...
* https://docs.netapp.com/us-en/ontap/authentication/install-server-certificate-cluster-svm-ssl-server-task.html["Genere e instale un certificado de servidor firmado por CA en ONTAP"^]
