...
Cuando instales y configures AFX por primera vez, puedes incluir opcionalmente NetApp AI Data Engine (AIDE). Si planeas configurar AIDE, primero tienes que hacer lo siguiente:

* Asegúrate de https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["instala AIDE"^] y conecta los nodos de computación a la red de almacenamiento AFX.
* Obtén las direcciones y cualquier configuración de red relacionada para los nodos de cálculo de datos.
...
. Si estás instalando AI Data Engine con tu sistema de almacenamiento AFX, proporciona las direcciones IP de los tres nodos AIDE DCN.
...
.¿Qué sigue?
* Si has incluido AIDE como parte de la configuración del clúster AFX, tendrás que realizar pasos de configuración adicionales, incluyendo la concesión de licencias y la autenticación. Consulta https://docs.netapp.com/us-en/ai-data-engine/install-setup/cluster-setup-afx.html["Configura AI Data Engine"^] para más información.
