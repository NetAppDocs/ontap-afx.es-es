...
NOTE: Si estás desplegando AFX 1K con el AI Data Engine (AIDE), instala los nodos de cómputo de datos AIDE después de encender el sistema AFX. Consulta link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Instala nodos de cómputo de datos AIDE"] para más información.
