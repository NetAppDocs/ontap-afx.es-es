...
image::../media/drw_afx_management_connection_ieops-2815.svg[Conéctese a su red de gestión]
...
+
image::../media/drw_afx_network_cabling_a_ieops-2813.svg[Cable a red Ethernet]
...
+
image::../media/drw_afx_network_cabling_b_ieops-2814.svg[Cable a red Ethernet]
