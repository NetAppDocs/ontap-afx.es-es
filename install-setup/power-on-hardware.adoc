...
.¿Que sigue?
Después de encender tu sistema de almacenamiento AFX 1K, completa la configuración según tu opción de implementación:

* Para implementaciones de sistemas de almacenamiento AFX 1K dedicados, ve a link:../install-setup/cluster-setup.html["Configura un clúster AFX"].
* Para implementaciones de AFX 1K con AI Data Engine (AIDE), instala servidores de terceros AIDE o nodos de cómputo de datos proporcionados por NetApp:
