...
* Para las implementaciones de AFX 1K con AI Data Engine (AIDE), ve a link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Instala nodos de cómputo de datos AIDE"].
